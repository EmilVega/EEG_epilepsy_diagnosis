function [CP_total, res, A,Wldc,Wqdc,Wknn,extraccionP,SVMdata,error_table, SeSp_table, LDCconf, QDCconf, KNNconf, SVMconf]=test_3classesClasf(filename,columnas)
    %% Initialize variables.
    clc
%     filename = 'feature_data3.csv';
    delimiter = ',';
    startRow = 2;
